            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Tambah Data Ekstrakurikuler</h5>
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                           <a href="{{ route('admin.eskul.tambah') }}">Tambah Ekstrakurikuler</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.eskul.store') }}" method="post" autocapitalize="off" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label for="nama_eskul">Nama Ekstrakurikuler</label>
                                    <input type="text" name="nama_eskul" id="nama_eskul" class="form-control" value="{{ old('nama_eskul')}}"> 
                                    @error('nama_eskul')
