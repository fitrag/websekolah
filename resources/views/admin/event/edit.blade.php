            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Data event</h5>
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                           <a href="{{ route('admin.event.tambah') }}">Edit event</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('admin/event/'.$data->id.'/edit') }}" method="post" autocapitalize="off" enctype="multipart/form-data">
                            @method('PUT')    
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="isi" id="konten" class="form-control"> {{ old('isi', $data->isi) }} </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input id="tgl" type="datetime"  class="form-control" name="tgl" value="{{  $data->tgl }}"  >
                                    </div>
                                    @error('tgl')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
