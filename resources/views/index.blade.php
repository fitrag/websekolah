  ...
  <main id="main">
    ...
    <div class="container">
      ...
      <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch"
        data-aos="fade-right">
        <a href="https://www.youtube.com/watch?v=P19bjxy-PDk" class="venobox play-btn mb-4" data-vbtype="video"
      ...
      <div
        ...
        <p data-aos="fade-up">SMKN 1 SEPUTIH AGUNG beralamat di JL. RAYA DONO ARUM. SIMPANG AGUNG, Dono Arum, Kec.
        Seputih Agung, Kab. Lampung Tengah, Lampung, dengan kode pos 34166.</p>

        <div class="icon-box" data-aos="fade-up">
        <div class="icon"><i class="bx bx-glasses"></i></div>
        <h4 class="title"><a href="">Visi</a></h4>
        <p class="description">Mewujudkan Lulusan Yang Berdaya Saing Global Dan Berkarakter Profile Pelajar
          Pancasila</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="col-lg-6 col-md-12">
        <h2 class="section-title">Jurusan SMK</h2>
    ...
    <div class="container">
      ...
      <div class="col-md-6 d-flex align-items-stretch py-2" data-aos="fade-up">
        ...
        <div class="card"
        style="background-image:url('{{ asset('images/berita/' . $thumbnail[0]) }}'); height:380px; object-fit: cover; object-position: center;">
        <div class="card-body">
        <h5 class="card-title"><a href="">{{ $item->title }}</a></h5>
        <p class="card-text">{!! Str::limit($item->body, 100) !!}</p>
        <div class="read-more"><a href="{{ url('show/' . $item->id)}}"><i class="icofont-arrow-right"></i> Read
          More</a></div>
        </div>
        </div>
      </div>
    @endforeach
      ...
      <a href="" class="btn btn-orange py-3 px-5">Lihat Semua Berita</a>
      </div>
    ...
    @endphp
      ...
      <img src="{{ asset('images/berita/' . $item->foto1) }}" class="img-preview img-fluid rounded mr-3" alt=""
      style="height:300px; width:400px; object-fit: cover; object-position: center;">
      <div class="portfolio-info">
      <h4>{{ $item->title }}</h4>
      <p>{!! Str::limit($item->body, 30) !!}</p>
      <a href="{{ asset('images/berita/' . $item->foto1) }}" data-gall="portfolioGallery"
    ...
    @endphp
      ...
      <img src="{{ asset('images/berita/' . $item->thumbnail) }}" class="img-fluid rounded mr-3" alt=""
      style="height:300px; width:400px; object-fit: cover; object-position: center;">
      <div class="portfolio-info">
      <h4>{{ $item->title }}</h4>
      {!! Str::limit($item->body, 30) !!}
      <a href="{{ asset('images/berita/' . $item->thumbnail) }}" data-gall="portfolioGallery"
    ...
    @endphp
      ...
      <img src="{{ asset('images/berita/' . $item->foto1) }}" class="img-fluid rounded mr-3" alt=""
      style="height:300px; width:400px; object-fit: cover; object-position: center;">
      <div class="portfolio-info">
      <h4>{{ $item->title }}</h4>
      <p>{!! Str::limit($item->body, 30) !!}</p>
