                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('admin.event.tambah')}}" class="btn btn-success btn-sm-mr">
                                    <i class="fa fa-plus">
                                        Tambah
                                    </i>
                                </a>
                                            ...
                                            @foreach ($events as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="event/{{ $item->id }}/edit" class="btn btn-primary btn-sm">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <form action="event/{{ $item->slug }}" class="d-inline" method="POST" onsubmit="return confirm('yakin hapus data')">
                                                            @method('delete')
                                                            @csrf
